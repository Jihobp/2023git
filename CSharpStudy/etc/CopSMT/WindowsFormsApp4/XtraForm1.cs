...
{   //Frm_BS_Mold.cs, + cls_Grid 참조(control)  Model& view
    ...
    public partial class XtraForm1 : DevExpress.XtraEditors.XtraForm
    {
        ...
        cls_Repository repo = new cls_Repository(); //데이터 저장 및 검색 작업을 처리하는 클래스로 보이는 cls_Repository 타입의 변수 rpo.
        /*
        ...
        */
        ...
        private void SetupDesign()
        {
            ...
            this.FormClosing += new FormClosingEventHandler((Sender, e) => { //람다식
                e.Cancel = false;
        ...
        private void SetupGrid_Mold(GridView gv)
        {
            ...
            BS_Customer customer = new BS_Customer();
        }
